...
export const TargetCursor: React.FC<TargetCursorProps> = ({
  ...
  useEffect(() => {
    ...
    const mouseDownHandler = () => {
      if (!dotRef.current || !activeTarget) return;
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ willChange: 'transform', borderColor: color }}
      />
      <div
