    ...
    <main className="relative w-full min-h-screen flex-col items-center justify-center font-mono overflow-x-hidden">   
      ...
      <div id="home" className="font-mono min-h-screen flex items-center justify-between relative">
        ...
        >
         ...
         <motion.div 
          ...
          className="font-mono flex-1 flex flex-col gap-2 w-full md:w-auto"
        >
          <Magnet padding={100} disabled={false} magnetStrength={50}>
            <span className="text-sm text-muted-foreground font-source drop-shadow-md">
              Hello, my name is Deniel Ivor
            </span>
           <div className="flex flex-col text-[24px] sm:text-[30px] font-lexend font-black">          
              <span className="items-center drop-shadow-md text-foreground">
                A Full-Stack Developer capable of{" "}
                <span className="text-cpurple drop-shadow-md">
                  creating
                </span>
                {" "}and{" "}
                <span className="text-cpurple drop-shadow-md">
            ...
            <div className="flex items-center gap-2 mt-4 border border-cgreen rounded-xl w-fit p-2">
      ...
      <div id="projects" className="font-mono min-h-screen w-full flex flex-col relative py-20 gap-12">
        <Magnet padding={10} disabled={false} magnetStrength={50}>   
          ...
          >
            <span className="mx-4 font-lexend text-4xl sm:text-5xl font-black drop-shadow-md"> my works </span>
            <span className="mx-4 font-mono text-md sm:text-lg text-cpurple drop-shadow-md" > - what I did </span>
          </motion.div>
        </Magnet>
        <MyWorksList />
    ...
    <div id="about" className="font-mono w-full flex flex-col mt-10 pb-20 relative gap-12">
      <Magnet padding={100} disabled={false} magnetStrength={50}>    
        <motion.div 
          ...
          className="font-mono flex flex-col gap-2 w-full"
        >
          <span className="mx-4 font-lexend text-4xl sm:text-5xl font-black drop-shadow-md"> about me </span>
          <span className="mx-4 font-mono text-md sm:text-lg text-cpurple drop-shadow-md"> - who am I? </span>
        </motion.div>
      </Magnet>
          ...
          <Magnet padding={50} disabled={false} magnetStrength={50}>    
            <div className="relative group mx-2">
              ...
              <div className="relative p-8 rounded-2xl bg-linear-to-br from-card/50 to-muted/30 border border-border/50 backdrop-blur-sm">
                ...
                <p className="text-sm sm-text-lg leading-relaxed text-muted-foreground mt-4">
        ...
        >
          ...
          <Magnet padding={100} disabled={false} magnetStrength={50} innerClassName="h-full col-span-1 bg-card/50 border border-border/50 rounded-2xl p-6 flex flex-col justify-between backdrop-blur-sm">       
            ...
            <div>
              ...
              <p className="text-sm sm-text-lg font-semibold text-foreground">Philippines</p>
            </div>
          </Magnet>
      ...
      <div id="connect" className="font-mono min-h-200 w-full flex items-center justify-center relative">
        <div className="flex flex-col justify-center items-center relative">
          <Magnet padding={80} disabled={false} magnetStrength={50}>    
            ...
            >
              <h1 className="font-lexend text-4xl sm:text-5xl font-black drop-shadow-md text-center"> let's connect! </h1>
              <p className="text-sm sm:text-md text-muted-foreground w-[80%] text-center drop-shadow-md">I'm always open to discussing new projects, creative ideas, or opportunities to be part of your vision.</p>
          ...
          >
            <Magnet padding={80} disabled={false} magnetStrength={50} wrapperClassName="w-full" innerClassName="flex flex-col sm:flex-row w-full gap-2 items-center justify-center drop-shadow-md">
              ...
              <span className="text-muted-foreground brightness-75 h-4 hidden sm:flex items-center flex-none">|</span>
      ...
      >
        ...
        <span className="text-sm text-muted-foreground drop-shadow-md text-center">© 2025 Deniel Ivor Cruz. All rights reserved.</span>
      </motion.div>
